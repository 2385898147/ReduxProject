...
import {welfareData} from "../../actions/requestHomeData";
...
class HomeFragment extends Component {
    ...
    render() {
        const {dataSource, mainThemeColor, pageBackgroundColor} = this.props;
        return (
    ...
    _fetchData() {
        this.props.actions(getCurrentDate());
    }
...
const styles = StyleSheet.create({
    ...
    scrollContents: {
        ...
        paddingBottom: theme.toolbar.height,
    },
    img: {
        width: theme.screenWidth,
        height: px2dp(400),
...
const mapDispatchToProps = (dispatch) => {
    return {
        actions: (date) => dispatch(welfareData(date)),
    };
};

        ...
        return (
            <View style={[styles.rowItem, {backgroundColor: rowItemBackgroundColor}]}>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <Text
                        style={{fontSize: px2dp(10), color: subTitleColor}}> {rowData.who ? rowData.who : 'null'}</Text>
                </View>
    ...
    _renderHeader() {
        ...
        return (
            <View style={[styles.header, {backgroundColor: rowItemBackgroundColor, borderTopColor: segmentColor}]}>
                <Avatar icon={this.tabIcon[this._judgeIconAttribute(headerTitle)]} width={px2dp(20)}
